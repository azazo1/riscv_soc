...
module rv32i_soc_sdram_app_vlg_tst;
  reg clk;
  reg rst_n;
  reg [9:0] sw;
  reg [3:0] key;
  ...
  initial begin
    ...
    $readmemh("build/tests/sdram_app/sdram_test.hex", app_image);
    ...
    wait_count = 0;
    while (ledr !== 10'h3ff && wait_count < 80000) begin
      wait_count = wait_count + 1;
      @(posedge clk);
    end
    #1;

    expect_value({22'b0, ledr}, 32'h0000_03ff, 32'd1);

    $display("rv32i_soc_sdram_app test passed");
    $finish;
  end
endmodule
