...
module sdram_arbiter (
  ...
  wire take_vga = !busy && !cpu_req && vga_req;
  wire take_any = take_cpu || take_vga;
  ...
  assign mem_addr = busy ? req_addr : (take_cpu ? cpu_addr : vga_addr);
